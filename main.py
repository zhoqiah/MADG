...
if __name__ == '__main__':
    ...
    parse.add_argument('-fuse_lr', type=float, default=2e-5, help='learning rate')  # 2e-5
    ...
    parse.add_argument('-optim_b2', type=float, default=0.999,
                       help='torch.optim.Adam betas_1')
    parse.add_argument('-data_path_name', type=str, default='fakenews',
                       help='train, dev and test data path name')  # 10-flod-1
    parse.add_argument('-data_type', type=str, default='fakenews',
                       help='Train data type: MVSA-single and MVSA-multiple and HFM')   # HFM
    ...
    parse.add_argument('-optim', type=str, default='adamw', help='Optimizer:adam, sgd, adamw')  # adam
    ...
    parse.add_argument('-cuda', action='store_true', default=True,
                       help='if True: use cuda. if False: use cpu')  # False
    ...
    if opt.data_type == 'HFM':
        ...
        image_coordinate = None
        data_translation_path = data_path_root + '/fakenews.json'
    elif opt.data_type == 'twitter':
        data_path_root = abl_path + 'dataset/data/twitter/'
        train_data_path = data_path_root + 'train.json'
        dev_data_path = data_path_root + 'valid.json'
        test_data_path = data_path_root + 'test.json'
        photo_path = data_path_root + '/images'
        image_coordinate = None
        data_translation_path = data_path_root + '/twitter.json'
    elif opt.data_type == 'weibo':
        data_path_root = abl_path + 'dataset/data/weibo/'
        train_data_path = data_path_root + 'train.json'
        dev_data_path = data_path_root + 'valid.json'
        test_data_path = data_path_root + 'test.json'
        photo_path = data_path_root + '/images'
    ...
    elif opt.data_type == 't':
        data_path_root = abl_path + 'dataset/data/t/'
        train_data_path = data_path_root + 'train.json'
        dev_data_path = data_path_root + 'valid.json'
        test_data_path = data_path_root + 'test.json'
        photo_path = data_path_root + '/images'
        image_coordinate = None
        data_translation_path = data_path_root + '/t.json'
    else:
    ...
    if opt.run_type == 1:
        ...
        print('\nTest Begin')
        model_path = "checkpoint/2022-09-18-19-07-29-Fakenews+token+sentences-contrastive+transformer+30/09-18-20-36-32-Acc-0.85480.pth"
